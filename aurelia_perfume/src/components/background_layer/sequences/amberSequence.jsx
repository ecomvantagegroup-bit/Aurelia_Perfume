// src/components/background_layer/sequences/AmberSequence.jsx
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const folder = isMobile ? '/golden_amber/mobile' : '/golden_amber/laptop_and_desktop';
    ...
    onMounted(() => {
      ...
      window.addEventListener('amber-scroll-progress', handleProgress);
    });

    onUnmounted(() => {
      window.removeEventListener('resize', handleResize);
      window.removeEventListener('amber-scroll-progress', handleProgress);
    });
